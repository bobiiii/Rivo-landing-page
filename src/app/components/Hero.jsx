    ...
    <div className="bg-primary min-h-[70vh] lg:min-h-[90vh] grid place-content-center">
      <div className="   flex justify-center flex-wrap lg:flex-nowrap   gap-5 ">
        <div className="w-full px-5 lg:w-6/12  ">
          <h3 className="text-secondary text-3xl leading-8 lg:text-[86px] font-[700]  text-center lg:text-left">
            Discover and Find Your Own Fashion!
          </h3>
          <p className="text-prePrimary py-4 mx-auto lg:mx-0  w-3/4 text-center text-sm lg:text-[24px] font-[500] leading-5 lg:leading-[210%]">
            Explore our curated collection of stylish clothing and accessories
            tailored to your unique taste.
          </p>
          <button className="bg-secondary text-white py-3 px-10 w-full mx-auto lg:my-5 shadow-xl3">
            Explore Now
          </button>
        </div>
